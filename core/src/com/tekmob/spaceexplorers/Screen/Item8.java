 ...
 */
public class Item8 extends BaseScreen {
    ...
    private void loadUI(){
        ...
        title = new Label(prefCont.getNameOfEncyclopedia("item7"), l);

        TextField.TextFieldStyle a = new TextField.TextFieldStyle();
        a.font = Assets.roboto;
        a.fontColor = Color.WHITE;

        desc = new TextArea(prefCont.getDescOfEncyclopedia("item7"), a);
        desc.setX(300);
        desc.setY(600);
        desc.setScaleY(200);
        ...
        distance = new Label(prefCont.getDistanceOfEncyclopedia("item7")+" AU",l);

        planet = new Image(Assets.loadTexture("item7.png"));
