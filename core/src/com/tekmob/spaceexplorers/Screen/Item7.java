 ...
 */
public class Item7 extends BaseScreen {
    ...
    private void loadUI(){
        ...
        title = new Label(prefCont.getNameOfEncyclopedia("item6"), l);

        TextField.TextFieldStyle a = new TextField.TextFieldStyle();
        a.font = Assets.roboto;
        a.fontColor = Color.WHITE;

        desc = new TextArea(prefCont.getDescOfEncyclopedia("item6"), a);
        desc.setX(300);
        desc.setY(600);
        desc.setScaleY(200);
        ...
        distance = new Label(prefCont.getDistanceOfEncyclopedia("item6")+" AU",l);

        planet = new Image(Assets.loadTexture("item6.png"));
