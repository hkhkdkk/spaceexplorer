 ...
 */
public class Item3 extends BaseScreen {
    ...
    private void loadUI(){
        ...
        title = new Label(prefCont.getNameOfEncyclopedia("item2"), l);

        TextField.TextFieldStyle a = new TextField.TextFieldStyle();
        a.font = Assets.roboto;
        a.fontColor = Color.WHITE;

        desc = new TextArea(prefCont.getDescOfEncyclopedia("item2"), a);
        desc.setX(300);
        desc.setY(600);
        desc.setScaleY(200);
        ...
        distance = new Label(prefCont.getDistanceOfEncyclopedia("item2")+" AU",l);

        planet = new Image(Assets.loadTexture("item2.png"));
