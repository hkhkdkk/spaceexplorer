...
public class HelpScreen extends BaseScreen {
    ...
    private Image background, image1, image2, image3, image4, image5, image6, image7;
    ...
    public HelpScreen(SpaceExplorer s) {
        ...
        skin.addRegions(Assets.howAtlas);
        loadUI();
        createUI();
    }
    ...
    private void loadUI(){
        ...
        image3 = new Image(skin.getRegion("asteroid"));
        image4 = new Image(skin.getRegion("power-up(s)"));
        image5 = new Image(skin.getRegion("power-up(m)"));
    ...
    private void createUI(){
        ...
        table1.add(image4);
        table1.add(image5);
        table.add(table1).left();

        table2.add(image6);
        table2.add(image7);
        table.add(table2).right();
        table.row().padTop(40);
