 ...
 */
public class Item6 extends BaseScreen {
    ...
    private void loadUI(){
        ...
        title = new Label(prefCont.getNameOfEncyclopedia("item5"), l);

        TextField.TextFieldStyle a = new TextField.TextFieldStyle();
        a.font = Assets.roboto;
        a.fontColor = Color.WHITE;

        desc = new TextArea(prefCont.getDescOfEncyclopedia("item5"), a);
        desc.setX(300);
        desc.setY(600);
        desc.setScaleY(200);
        ...
        distance = new Label(prefCont.getDistanceOfEncyclopedia("item5")+" AU",l);

        planet = new Image(Assets.loadTexture("item5.png"));
